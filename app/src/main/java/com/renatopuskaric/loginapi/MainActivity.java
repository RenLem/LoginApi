...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.textView_userMainActivity);
    ...
    public void rest() throws InterruptedException {
        ...
        final TextView textView = findViewById(R.id.textView_userMainActivity);
        ...
        Call<User> userList = restApi.getApiUserData();
